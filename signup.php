...
<!-- <div class="form-group">
  ...
  <div class="password-toggle">
    ...
    <span class="toggle-icon"><i class="fa fa-eye-slash"></i></span>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="password-toggle">
    <input class="form-control" type="password" id="confirm-password" name="confirm-password" autocomplete="off" required>
    <span class="toggle-icon"><i class="fa fa-eye-slash"></i></span>
  </div>
</div> -->
<div class="form-group">
...
<!-- <script>
  ...
  registerButton.addEventListener('click', () => {
    ...
    if (password === confirmPassword) {
      ...
      // Make an AJAX request to your registration endpoint
